...
### Bug Fixes
* Define CCaaS chaincode containers in Docker Compose and use shared per-org package labels so `fablo down` removes them cleanly [#653](https://github.com/hyperledger-labs/fablo/issues/653)
