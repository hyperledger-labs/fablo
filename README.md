...
```bash
sudo curl -Lf https://github.com/hyperledger-labs/fablo/releases/download/1.3.0/fablo.sh -o /usr/local/bin/fablo && sudo chmod +x /usr/local/bin/fablo
```

To get a copy of Fablo for a single project, execute in the project root:

```bash
curl -Lf https://github.com/hyperledger-labs/fablo/releases/download/1.3.0/fablo.sh -o ./fablo && chmod +x ./fablo
```
...
```json
{
  "$schema": "https://github.com/hyperledger-labs/fablo/releases/download/1.3.0/schema.json",
  "global": { ... },
  "orgs": [ ... ],
  "channels": [ ... ],
  "chaincodes": [ ... ]
