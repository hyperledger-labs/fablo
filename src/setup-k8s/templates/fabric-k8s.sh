...
FABRICOPS_INSTALL_URL="https://github.com/LF-Decentralized-Trust-labs/FabricOps#installation"
...
requireFabricOpsctl() {
  if ! command -v fabricopsctl >/dev/null 2>&1; then
    ...
    echo "Install it with: go install github.com/LF-Decentralized-Trust-labs/FabricOps/cmd/fabricopsctl@latest"
