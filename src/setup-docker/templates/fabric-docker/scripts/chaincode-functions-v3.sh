#!/usr/bin/env bash
# Chaincode functions for Fabric v3 networks.
# Currently equivalent to the v2 variant. Kept as a separate file so that
# v3-specific changes can be introduced here without affecting v2 networks.
