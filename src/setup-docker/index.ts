...
export default class SetupDockerGenerator extends Generator {
  ...
  _copyUtilityScripts(global: Global): void {
    ...
    this.fs.copyTpl(this.templatePath("download-bin.sh"), this.destinationPath("download-bin.sh"), global);
    ...
    this.fs.copyTpl(
      this.templatePath(`fabric-docker/scripts/chaincode-functions-${global.capabilities.isV2 ? "v2" : "v1.4"}.sh`),
