...
waitForChaincode "cli.org1.com" "peer0.org1.com:7071" "my-channel1" "or-policy-chaincode" "0.0.1"
waitForChaincode "cli.org2.com" "peer0.org2.com:7081" "my-channel1" "or-policy-chaincode" "0.0.1"
...
expectInvoke "cli.org2.com" "peer0.org2.com:7081" "my-channel1" "or-policy-chaincode" \
  '{"Args":["KVContract:verifyPrivateMessage", "org1-collection"]}' \
  '{\"success\":\"OK\"}' \
  '{"message":"VmVyeSBzZWNyZXQgbWVzc2FnZQ=="}'
expectInvoke "cli.org2.com" "peer0.org2.com:7081" "my-channel1" "or-policy-chaincode" \
...
expectInvoke "cli.org1.com" "peer0.org1.com:7071,peer0.org2.com:7081" "my-channel1" "and-policy-chaincode" \
  '{"Args":["KVContract:putPrivateMessage", "org1-collection"]}' \
  '{\"success\":\"OK\"}' \
  '{"message":"RG9udCBjaGFuZ2UgbWUgcGx6"}'
expectInvoke "cli.org2.com" "peer0.org2.com:7081,peer0.org1.com:7071" "my-channel1" "and-policy-chaincode" \
  '{"Args":["KVContract:getPrivateMessage", "org1-collection"]}' \
